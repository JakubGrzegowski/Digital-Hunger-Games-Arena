...
class World:
    ...
    def move(self):
        for gladiator in self.gladiatorArray:
            ...
            for move in range(gladiator.speed):
                ...
                while True:
                    drow = random.randint(-1, 1)
                    dcol = random.randint(-1, 1)

                    if 0 <= gladiator.position[0] + drow < self.sizeX and 0 <= gladiator.position[1] + dcol < self.sizeY:
    ...
    def fight(self, attacker, defender):
        ...
        while True:
            ...
            else: print(attacker.name, " dealt 0 damage, ", defender.name, " HP = ", defender.hp)
            if defender.hp <= 0:
            ...
            else: print(defender.name," dealt 0 damage", attacker.name, " HP = ",attacker.hp)
